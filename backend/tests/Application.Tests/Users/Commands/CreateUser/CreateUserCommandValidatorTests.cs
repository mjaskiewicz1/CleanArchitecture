...
public sealed class CreateUserCommandValidatorTests(CreateUserCommandValidators validator)
    : BaseValidatorTest<CreateUserCommandValidators>(validator)
{
    ...
    public async Task Should_Fail_When_Field_Is_Empty(string firstName, string lastName, string email, string expectedProperty)
    {
        // Arrange
    ...
    public async Task Should_Fail_When_FirstName_Exceeds_MaxLength()
    {
        ...
        var command = new CreateUserCommand(tooLong, "Doe", "john@example.com", []);
    ...
    public async Task Should_Fail_When_LastName_Exceeds_MaxLength()
    {
        ...
        var command = new CreateUserCommand("John", tooLong, "john@example.com", []);
    ...
    public async Task Should_Fail_When_Email_Exceeds_MaxLength()
    {
        ...
        var command = new CreateUserCommand("John", "Doe", tooLongEmail, []);
